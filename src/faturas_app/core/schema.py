...
CANONICAL_COLUMNS = {
    ...
    "unidade_consumidora": [
        ...
        "municipio",
        "uf",
        # Cadastro vindo do MAPA DE UCs importado (core/dicionario_uc.py).
        # Só existem quando há mapa carregado E o item foi mapeado na
        # importação — o schema lista para fixar a ORDEM; quem cria (ou não
        # cria) é derivados._enriquecer_mapa_uc.
        "id_uc_aneel_bordero",
        "uc_operante",
